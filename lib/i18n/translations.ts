...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    editor: {
      ...
      importNoticeFreeflowMode: 'You are in Free Flow mode — ideal for importing text written outside Biography Library. The entire imported text will replace your current Free Flow content. If you prefer a guided, chapter-by-chapter approach, switch to Sections mode before importing.',
  ...
  it: {
    ...
    editor: {
      ...
      importNoticeFreeflowMode: 'Sei in modalità Testo libero — ideale per importare testo scritto fuori da Biography Library. Il testo importato sostituirà l\'intero contenuto attuale. Se preferisci un approccio guidato capitolo per capitolo, passa alla modalità Sezioni prima di importare.',
  ...
  fr: {
    ...
    editor: {
      ...
      importNoticeFreeflowMode: 'Vous êtes en mode Texte libre — idéal pour importer un texte rédigé en dehors de Biography Library. Le texte importé remplacera l\'intégralité du contenu actuel. Si vous préférez une approche guidée chapitre par chapitre, passez en mode Sections avant d\'importer.',
  ...
  de: {
    ...
    editor: {
      ...
      importNoticeFreeflowMode: 'Sie befinden sich im Freitextmodus — ideal für den Import von Texten, die außerhalb von Biography Library geschrieben wurden. Der importierte Text ersetzt den gesamten aktuellen Inhalt. Wenn Sie einen geführten, kapitelweisen Ansatz bevorzugen, wechseln Sie vor dem Import in den Abschnittsmodus.',
